...
if (version_compare(PHP_VERSION, '5.3.0') < 0) 
{
	...
	print "<html><head><title>A1CMS required PHP version 5.3+ / Необходима версия PHP 5.3 или выше</title></head><body><div style='font: 24px verdana; background-color: #EEEEEE; border: #ABCDEF 1px solid; margin: 1px; padding: 3px;'><span style='color: red;'>FATAL ERROR / Фатальная ошибка</span><br/><br/><span style=\"font: 16px arial;\"> A1CMS requires PHP version <b>5.3+</b><br/>Please ask your hosting provider to upgrade your account</span><br/><hr/><span style=\"font: 16px arial;\"> Для работы A1CMS требуется PHP версии <b>5.3</b> или выше.<br/>Обратитесь к вашему хостинг провайдеру для обновления версии</span></div></body></html>";
	exit;
}
...
if (isset($engine_config['is_installed']) && $engine_config['is_installed']==0)
