...
$config['site_dir']=root.'plugins/images';
// $config['uploaddir']=$config['site_dir'].'/img/';
$config['uploaddir']=$engine_config['images_dir'].'/';
// $config['thumbdir']=$config['site_dir'].'/thumbs/';
$config['thumbdir']=$engine_config['images_dir'].'/thumbs/';
// $config['working_dir']=$config['site_dir'].'/working/';
$config['working_dir']=$engine_config['images_dir'].'/working';
...
$folder='plugins/images';
$config['site_url']='http://'.$_SERVER['HTTP_HOST'].'/'.$folder.'/';  //отныне и тут - "системный", для подгрузки css и шаблонов по правильному пути.
$config['thumbs_url']=$engine_config['images_path_http'].'/thumbs/';
$config['img_url']=$engine_config['images_path_http'].'/'; //отныне и тут - для подгрузки картинок
...
// $config['allow_control']=array(1,2,3,4,6);
?>