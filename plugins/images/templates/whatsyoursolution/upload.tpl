...
<input type="hidden" name="action" value="upload" />
		...
		<div class="right_right">
		  ...
		  <textarea name="web_uploadfile" class="linksarea" id="imgtextarea"></textarea>
		</div>
...
<div align='center'>
		...
		<fieldset class='fieldsets'>
		<legend><label><input type="checkbox" id="preview" name="thumb" value="true" checked /> Создать превью</label><br /></legend>
				<br />
				<label>Ширина: <input name="thumb_width" size="10" type="text" value="80" class="preview_elements"></label>
				...
				<label><input type="radio" name="texttype" value="nothing" class="preview_elements" id="nothing" checked>Ничего</label>&nbsp;&nbsp;<br />
				<label><input type="text" name="text" size="25" class="preview_elements" id="preview_text" /><br /><br />
		</fieldset>
		<br /><br/ >
		<input type="submit" value="Загрузить"> 
		<!-- <button type='button' class='btn' onclick="javascript:ImgUpload('','upload');">Загрузить</button> -->
</div>
